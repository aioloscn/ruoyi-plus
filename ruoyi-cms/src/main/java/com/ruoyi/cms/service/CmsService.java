...
import com.ruoyi.cms.resources.AliyunResource;
...
public class CmsService {
    ...
    public String uploadOSS(MultipartFile file, String suffix) throws IOException {
        ...
        String myObjectName = fileResource.getObjectName() + File.separator + dataPath + File.separator + idWorker.nextIdStr() + "." + suffix;
        System.out.println(myObjectName);
